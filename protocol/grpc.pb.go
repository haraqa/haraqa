...
type ProduceRequest struct {
	...
	MsgSizes []int64 `protobuf:"varint,3,rep,packed,name=msg_sizes,json=msgSizes,proto3" json:"msg_sizes,omitempty"`
}
...
func (m *ProduceRequest) GetTopic() []byte {
	if m != nil {
		return m.Topic
	}
	return nil
...
func (m *ProduceRequest) GetUuid() []byte {
	if m != nil {
		return m.Uuid
	}
	return nil
...
func (m *ProduceRequest) GetMsgSizes() []int64 {
	if m != nil {
		return m.MsgSizes
	}
	return nil
...
func (m *ProduceResponse) GetMeta() *Meta {
	if m != nil {
		return m.Meta
	}
	return nil
...
func (m *ConsumeRequest) GetTopic() []byte {
	if m != nil {
		return m.Topic
	}
	return nil
...
func (m *ConsumeRequest) GetUuid() []byte {
	if m != nil {
		return m.Uuid
	}
	return nil
...
func (m *ConsumeRequest) GetMaxBatchSize() int64 {
	if m != nil {
...
func (m *ConsumeResponse) GetMeta() *Meta {
	if m != nil {
		return m.Meta
	}
	return nil
...
func (m *ConsumeResponse) GetMsgSizes() []int64 {
	if m != nil {
		return m.MsgSizes
	}
	return nil
...
// The request message containing the close info
...
// The response message containing the close ack
...
func (m *CloseResponse) GetMeta() *Meta {
	if m != nil {
		return m.Meta
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ConsumeRequest)(nil), "protocol.ConsumeRequest")
	proto.RegisterType((*ConsumeResponse)(nil), "protocol.ConsumeResponse")
	proto.RegisterType((*CloseRequest)(nil), "protocol.CloseRequest")
	proto.RegisterType((*CloseResponse)(nil), "protocol.CloseResponse")
...
var fileDescriptor_bedfbfc9b54e5600 = []byte{
	...
	,
}
...
type HaraqaClient interface {
	...
	CloseConnection(ctx context.Context, in *CloseRequest, opts ...grpc.CallOption) (*CloseResponse, error)
...
func (c *haraqaClient) Produce(ctx context.Context, in *ProduceRequest, opts ...grpc.CallOption) (*ProduceResponse, error) {
...
func (c *haraqaClient) Consume(ctx context.Context, in *ConsumeRequest, opts ...grpc.CallOption) (*ConsumeResponse, error) {
...
func (c *haraqaClient) CloseConnection(ctx context.Context, in *CloseRequest, opts ...grpc.CallOption) (*CloseResponse, error) {
	out := new(CloseResponse)
	err := c.cc.Invoke(ctx, "/protocol.Haraqa/CloseConnection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HaraqaServer interface {
	...
	// Closes the client connection gracefully
	CloseConnection(context.Context, *CloseRequest) (*CloseResponse, error)
	// Sends a message to get a topics beginning and ending offsets
...
func (*UnimplementedHaraqaServer) Produce(ctx context.Context, req *ProduceRequest) (*ProduceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Produce not implemented")
}
func (*UnimplementedHaraqaServer) Consume(ctx context.Context, req *ConsumeRequest) (*ConsumeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Consume not implemented")
}
func (*UnimplementedHaraqaServer) CloseConnection(ctx context.Context, req *CloseRequest) (*CloseResponse, error) {
...
func _Haraqa_Produce_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HaraqaServer).Produce(ctx, req.(*ProduceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Haraqa_Consume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HaraqaServer).Consume(ctx, req.(*ConsumeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Haraqa_CloseConnection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CloseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HaraqaServer).CloseConnection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.Haraqa/CloseConnection",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HaraqaServer).CloseConnection(ctx, req.(*CloseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Haraqa_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Haraqa_CloseConnection_Handler,
		},
		{
			MethodName: "Offsets",
...
func (m *ProduceRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.MsgSizes) > 0 {
		dAtA6 := make([]byte, len(m.MsgSizes)*10)
		var j5 int
		...
		i = encodeVarintGrpc(dAtA, i, uint64(j5))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Uuid) > 0 {
		i -= len(m.Uuid)
		copy(dAtA[i:], m.Uuid)
		i = encodeVarintGrpc(dAtA, i, uint64(len(m.Uuid)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Topic) > 0 {
...
func (m *ConsumeRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.MaxBatchSize != 0 {
		i = encodeVarintGrpc(dAtA, i, uint64(m.MaxBatchSize))
		i--
		dAtA[i] = 0x20
	}
	if m.Offset != 0 {
...
func (m *ConsumeRequest) Size() (n int) {
	...
	if m.MaxBatchSize != 0 {
		n += 1 + sovGrpc(uint64(m.MaxBatchSize))
	}
	return n
}
