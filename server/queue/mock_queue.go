...
func (m *MockQueue) TruncateTopic(topic string, id int64) (*TopicInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TruncateTopic", topic, id)
	ret0, _ := ret[0].(*TopicInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockQueue) InspectTopic(topic string) (*TopicInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockQueue) Consume(topic string, id, n int64) (*ConsumeInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Consume", topic, id, n)
	ret0, _ := ret[0].(*ConsumeInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
